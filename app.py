...
while True:
    try:
        ...
        # Prompt the user after download
        choice = input("Do you want to download another video? (1 for yes, 2 for no): ").strip()
        if choice != '1':
        ...
        # Optionally prompt again after error, or continue to loop
        choice = input("Do you want to try again? (1 for yes, 2 for no): ").strip()
        if choice != '1':
            print("Ending the script.")
            break